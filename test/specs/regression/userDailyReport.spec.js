...
describe('USER CREATE DAILY REPORT', () => {
  ...
  it.only('should display the correct title "I need help"', () => {
  ...
  it('should display the correct title "I understood everything"', () => {
    expect(dailyReport.iUnderstoodEverythingCheckbox.getText()).eq(
      dailyReportData.iUnderstoodCheckbox,
    );
  });

  it('should display the correct title "Helped classmates"', () => {
    expect(dailyReport.helpedClassmatesCheckbox.getText()).eq(
      dailyReportData.helpedClassmatesCheckbox,
    );
  });

  it('should display the correct title "Watched lectures"', () => {
    expect(dailyReport.watchedLecturesCheckbox.getText()).eq(
      dailyReportData['watchedLecturesCheckbox'],
    );
  });

  it('should display the correct title "Read documentation"', () => {
    expect(dailyReport.readDocumentationCheckbox.getText()).eq(
      dailyReportData.readDocumentationCheckbox,
    );
  });
  ...
  it('should display the correct title "Interview preparation"', () => {
    expect(dailyReport.interviewPreparationCheckbox.getText()).eq(
      dailyReportData.interviewPreparationCheckbox,
    );
  });

  it('should display the correct title "Recruiter phone call"', () => {
    expect(dailyReport.recruiterPhoneCallCheckbox.getText()).eq(
      dailyReportData.recruiterPhoneCallCheckbox,
    );
  });

  it('should display the correct title "Interview technical screen"', () => {
    expect(dailyReport.interviewTechnicalScreenCheckbox.getText()).eq(
      dailyReportData.interviewTechnicalScreenCheckbox,
    );
  });

  it('should display the correct title "Interview onsite"', () => {
    expect(dailyReport.interviewOnsiteCheckbox.getText()).eq(
      dailyReportData.interviewOnsiteCheckbox,
    );
  });
